...
def ordered_one_bit(image: Image.Image, levels: int) -> list[int]:
    output: list[int] = []
    pixels = image.load()
...
def main() -> None:
    ...
    parser.add_argument("--name", required=True,
                        help="asset stem, for example clock or animation_gallery")
    ...
    if args.input.resolve() != source_path.resolve():
    ...
    for suffix, size, symbol_suffix in variants:
        ...
        pixels = ordered_one_bit(grayscale, args.levels)
