#!/usr/bin/env python3
"""Prepare the third priority batch for the remaining congested nets."""
...
SOURCE = ROOT / "cadenza-d1-v42-stage2-routed.kicad_pcb"
BOARD_OUT = ROOT / "cadenza-d1-v42-stage3-base.kicad_pcb"
DSN_OUT = ROOT / "cadenza-d1-v42-stage3.dsn"

NEXT_POWER = {"/VBUS", "/GAUGE_VDD"}
NEXT_SIGNAL = {"/CHG_N", "/I2S_LRCLK", "/PGOOD_N", "/ILIM_SET"}
GROUND = {"/GND"}
...
def main():
    ...
    if not pcbnew.ExportSpecctraDSN(board, str(DSN_OUT)):
        raise RuntimeError("KiCad failed to export stage-3 DSN")
    all_nets = {
        net.GetNetname()
