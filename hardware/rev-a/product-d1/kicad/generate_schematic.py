...
SYMBOLS = {
    ...
    "BQ27441": Symbol("BQ27441", (("SDA", "1"), ("SCL", "2"), ("VSS", "3"), ("NC", "4"),
        ("VDD", "5"), ("BAT", "6"), ("SRN", "7"), ("SRP", "8"), ("NC", "9"),
        ("BIN", "10"), ("NC", "11"), ("GPOUT", "12"), ("EP", "13"))),
    ...
    "TESTPOINT": Symbol("TESTPOINT", (("TP", "1"),)),
...
def esp_nets():
    ...
    gpio = {
        1: "PGOOD_N", 2: "LED_CTRL", 4: "ENC_A", 5: "ENC_B", 6: "A_SW", 7: "I2S_DIN", 8: "I2C_SDA",
        9: "SD_CD", 16: "I2S_BCLK", 21: "GAUGE_INT_N",
        ...
        41: "AMP_EN", 42: "PDM_DATA", 47: "B_SW", 48: "MENU_SW", 0: "BOOT_N",
    }
...
PARTS = [
    ...
    Part("U2", "BQ24074RGTR", "BQ24074", "Package_DFN_QFN:VQFN-16-1EP_3x3mm_P0.5mm_EP1.68x1.68mm_ThermalVias", "BQ24074RGTR", "C54313", 4700, 1700,
         {"1":"BAT_TS", "2":"VBAT", "3":"VBAT", "4":"GND", "5":"GND", "6":"VSYS", "7":"PGOOD_N", "8":"GND", "9":"CHG_N", "10":"VSYS", "11":"VSYS", "12":"ILIM_SET", "13":"VBUS", "14":"TMR_SET", "15":"ITERM_SET", "16":"ISET_SET", "17":"GND"}),
    Part("U3", "TPS63070RNMR", "TPS63070", "Cadenza_D1:TI_RNM0015A_VQFN-HR-15_TI4222000B", "TPS63070RNMR", "C109322", 7200, 1700,
    ...
    Part("U7", "BQ27441DRZR-G1A", "BQ27441", "Package_SON:Texas_S-PDSO-N12", "BQ27441DRZR-G1A", "C473397", 7200, 6200,
         {"1":"I2C_SDA", "2":"I2C_SCL", "3":"GND", "5":"GAUGE_VDD", "6":"PACKP", "7":"VBAT", "8":"PACKP", "10":"GAUGE_BIN", "12":"GAUGE_INT_N", "13":"GND"}),
    Part("J3", "microSD push-push", "MICROSD_10", "Connector_Card:microSD_HC_Hirose_DM3AT-SF-PEJM5", "DM3AT-SF-PEJM5", "C114218", 9700, 6200,
         {"1":"NC", "2":"SD_CS", "3":"SD_CMD", "4":"+3V3_MAIN", "5":"SD_CLK", "6":"GND", "7":"SD_DAT0", "8":"NC", "9":"SD_CD", "10":"GND"}, "Card detect switch to GPIO9; sample-check shell aperture"),
    ...
    Part("J4", "LiPo 1S", "CONN_2", "Connector_JST:JST_PH_B2B-PH-SM4-TB_1x02-1MP_P2.00mm_Vertical", "B2B-PH-SM4-TB", "TBD", 4700, 7600, {"1":"PACKP", "2":"GND"}),
    ...
    Part("TP1", "UART_TX", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 4700, 10200, {"1":"UART_TX0"}, "Copper-only service pad; exclude from PCBA BOM"),
    Part("TP2", "UART_RX", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 7200, 10200, {"1":"UART_RX0"}, "Copper-only service pad; exclude from PCBA BOM"),
    Part("TP3", "GND", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 9700, 10200, {"1":"GND"}, "Copper-only service pad; exclude from PCBA BOM"),
    Part("TP4", "PG_3V3", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 2100, 11400, {"1":"PG_3V3_N"}, "Copper-only bring-up pad; exclude from PCBA BOM"),
    Part("TP5", "PACKP", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 4700, 11400, {"1":"PACKP"}, "Copper-only power test pad; exclude from PCBA BOM"),
    Part("TP6", "VBAT", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 7200, 11400, {"1":"VBAT"}, "Copper-only power test pad; exclude from PCBA BOM"),
    Part("TP7", "VSYS", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 9700, 11400, {"1":"VSYS"}, "Copper-only power test pad; exclude from PCBA BOM"),
    Part("TP8", "+3V3", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 2100, 12600, {"1":"+3V3_MAIN"}, "Copper-only power test pad; exclude from PCBA BOM"),
    Part("TP9", "+5V", "TESTPOINT", "TestPoint:TestPoint_Pad_D1.0mm", "PCB_TEST_PAD", "N/A", 4700, 12600, {"1":"+5V_MEDIA"}, "Copper-only power test pad; exclude from PCBA BOM"),
]
...
PASSIVES = [
    ...
    ("R73","0.01R 1% 1W 50ppm","PACKP","VBAT"), ("R74","10k","GAUGE_INT_N","+3V3_MAIN"),
    ("R75","100k","PGOOD_N","+3V3_MAIN"), ("R76","100k","PG_3V3_N","+3V3_MAIN"),
    ("R77","100k","CHG_N","+3V3_MAIN"),
    ("R30","100k","VSYS","RUN_EN"),
    ("R90","10k","SD_CS","+3V3_MAIN"), ("R91","10k","SD_CMD","+3V3_MAIN"),
    ("R92","10k","SD_DAT0","+3V3_MAIN"), ("R93","10k","SD_CD","+3V3_MAIN"),
    ...
    ("C70","1uF","PACKP","GND"), ("C71","1uF","GAUGE_VDD","GND"),
    ("C80","1uF","ESP_EN","GND"), ("C81","10uF","+3V3_MAIN","GND"), ("C82","100nF","+3V3_MAIN","GND"),
    ("C90","10uF","+3V3_MAIN","GND"), ("C91","100nF","+3V3_MAIN","GND"),
...
def component_block(part: Part, stamp: int) -> list[str]:
    return [
        ...
        f'F 4 "{part.mpn}" H {part.x} {part.y} 50  0001 C CNN "MPN"',
        f'F 5 "{part.lcsc}" H {part.x} {part.y} 50  0001 C CNN "LCSC"',
