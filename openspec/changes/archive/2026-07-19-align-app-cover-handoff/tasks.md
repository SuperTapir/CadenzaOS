...
- [x] 1.6 增加四 App 双 profile 的 return p0=App、共享 Cover 区域、p1=稳定 Launcher 与 30 FPS 相邻变化上限失败测试
...
- [x] 3.5 让 App → Cover 匀速交接，并将 bridge 几何对齐 Launcher 的奇数像素中心规则
...
- [x] 5.6 生成四 App 完整 30 FPS 返回 PNG/GIF，复核运动峰值与 Sharp Cover 坐标并重跑完整验证
