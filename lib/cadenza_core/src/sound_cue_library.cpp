    ...
    kPalette{{
        ...
        {{{event(resonator(659.25F, 659.25F, 0.380F, 0.21F, 0.170F, 0.20F,
           ...
           event(resonator(293.66F, 293.66F, 0.390F, 0.30F, 0.140F, 0.50F,
                 ...
                 0.270F)}},
         3},
        {{{event(resonator(783.99F, 783.99F, 0.280F, 0.26F, 0.105F, 0.03F,
                           3, 0.00035F, 0.018F, 0.10F)),
           event(resonator(1046.50F, 1046.50F, 0.320F, 0.22F, 0.125F,
                           0.17F, 3, 0.00035F, 0.020F, 0.09F),
                 0.140F),
           event(resonator(1318.51F, 1318.51F, 0.410F, 0.18F, 0.165F,
                           0.31F, 3, 0.00035F, 0.024F, 0.08F),
                 0.290F),
           event(resonator(1567.98F, 1567.98F, 0.410F, 0.14F, 0.175F,
